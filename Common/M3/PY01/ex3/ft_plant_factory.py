...
class Grasse(Plant):
    ...
    def print_info(self):
        msg = (f"Created: {self.name} (Grasse) - {self.height_cm}cm "
               f"- {self.age_d} days")
        print(msg)
...
class Rampicanti(Plant):
    ...
    def print_info(self):
        msg = (f"Created: {self.name} (Rampicante) - {self.height_cm}cm "
               f"- {self.age_d} days")
        print(msg)
...
class Tropicali(Plant):
    ...
    def print_info(self):
        msg = (f"Created: {self.name} (Tropicale) - {self.height_cm}cm "
               f"- {self.age_d} days")
        print(msg)
...
class Aromatiche(Plant):
    ...
    def print_info(self):
        msg = (f"Created: {self.name} (Aromatica) - {self.height_cm}cm "
               f"- {self.age_d} days")
        print(msg)
...
class Aquactiche(Plant):
    ...
    def print_info(self):
        msg = (f"Created: {self.name} (Acquatica) - {self.height_cm}cm "
               f"- {self.age_d} days")
        print(msg)
