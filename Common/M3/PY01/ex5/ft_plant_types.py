...
class Flower(Plant):
	...
	def get_info(self):
		print(f"{self.name} (Flower): {self.height_cm}, {self.age_d} days, {self.color} color")
...
class Tree(Plant):
	...
	def get_info(self):
		print(f"{self.name} (Tree): {self.height_cm}cm, {self.age_d} days, {self.diameter_cm}cm diameter")


class Vegetable(Plant):
	def __init__(self, name, height_cm, age_d, harvest_season, nutritional_value):
		super().__init__(name, height_cm, age_d)
		self.harvest_season = harvest_season
		self.nutrinational_value = nutritional_value

	def get_info(self):
		print(f"{self.name} (Vegetable): {self.height_cm}cm, {self.age_d} days, {self.harvest_season} harvest")
